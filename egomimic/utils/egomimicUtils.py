...
EXTRINSICS = {
    ...
    "ariaJul29R": np.array([[ 0.07280155, -0.81760187,  0.57116295,  0.12038065],
       ...
       [ 0.        ,  0.        ,  0.        ,  1.        ]]),
    "aria_jaka":{
        'left': np.array([[-0.9981516 ,  0.06045112, -0.00624908,  0.01950012],
       [ 0.04486497,  0.66360411, -0.74673738,  0.15614218],
       [-0.04099419, -0.74563748, -0.66508964,  1.01037605],
       [ 0.        ,  0.        ,  0.        ,  1.        ]]),

        'left_old': np.array([[-0.99884331, -0.00142335, -0.0480626 , -0.18752439],
